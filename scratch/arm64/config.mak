...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --enable-gpl --enable-libx264 --extra-cflags='-arch arm64 -mios-version-min=6.0 -I/Users/toptierlabs/Desktop/Projects/test/x264/x264-iOS/include' --extra-cxxflags='-arch arm64 -mios-version-min=6.0' --extra-ldflags='-arch arm64 -mios-version-min=6.0 -L/Users/toptierlabs/Desktop/Projects/test/x264/x264-iOS/lib' --prefix=/Users/toptierlabs/Desktop/Projects/test/thin/arm64
...
CFLAGS=  -arch arm64 -mios-version-min=6.0 -I/Users/toptierlabs/Desktop/Projects/test/x264/x264-iOS/include -std=c99 -fomit-frame-pointer -fPIC -pthread -I/usr/local/Cellar/x264/r2455/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS= -arch arm64 -mios-version-min=6.0 -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch arm64 -mios-version-min=6.0 -I/Users/toptierlabs/Desktop/Projects/test/x264/x264-iOS/include -fPIC -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -mios-version-min=6.0 -L/Users/toptierlabs/Desktop/Projects/test/x264/x264-iOS/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
